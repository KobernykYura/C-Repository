...
*/
    ...
    /// Класс Собака.
    /// </summary>
    class Dog : AbstractAnimal, Interfaces.IRunable, Interfaces.ISniff
    {
        /// <summary>
        /// Конструктор собаки.
        /// </summary>
        /// <param name="name">Имя собаки.</param>
        public Dog(string name) : base(name, 4, AnimalType.Mammals, false)
        {
        }
        ...
        {
            if (food.FoodType == FoodType.meat || food.FoodType == FoodType.water) { GoodOut(food); }
            else { BadOut(food); }
        }
