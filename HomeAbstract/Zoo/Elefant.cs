...
*/
    ...
    class Elefant : AbstractAnimal, Interfaces.IRunable, Interfaces.ISniff
    {
        /// <summary>
        /// Конструктор слон.
        /// </summary>
        /// <param name="name">Имя слон.</param>
        public Elefant(string name) : base(name, 4, AnimalType.Mammals, false)
        {
        }
        ...
        /// Метод команды "голос"!
        /// </summary>
        /// <returns>Возвращает строку "Uur-urr"</returns>
